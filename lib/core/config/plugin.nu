...
$env.config.plugins = {
  ...
  theme: {
    ...
    install_hooks: [
      ...
      {
        from: 'https://github.com/folke/tokyonight.nvim/raw/refs/heads/main/extras/lazygit/tokyonight_night.yml'
        to: '~/.config/lazygit/themes/tokyonight.yml'
        mkdir: true
        overwrite: true
      }
      {
        from: 'https://github.com/catppuccin/lazygit/raw/refs/heads/main/themes/mocha/lavender.yml'
        to: '~/.config/lazygit/themes/catppuccin-mocha.yml'
        mkdir: true
        overwrite: true
      }
    ]
    ...
    definitions: [
...

      {
        ...
        cmd: { |theme_name|
          ...
          try {
            rm --force --recursive --permanent $lazygit_config_file;
          }
          cp --force --recursive $'($lazygit_config_file | path dirname)/themes/($theme_name).yml' $lazygit_config_file
        }
      }
